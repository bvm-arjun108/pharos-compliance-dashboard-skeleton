...
public record BatchDetailsProjection(int reportGroupId, String reportGroupName, String batchId, int sequenceNumber,
    ...
    long duplicateTransactions, long filtrationErrors, long reconciliationImbalance, long selectedTransactions,
    long transactionAttemptsFound, long expectedReportableTransactions, long actualReportableTransactions,
