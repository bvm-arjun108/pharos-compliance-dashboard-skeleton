...
public record TransactionReportContextProjection(int reportGroupId, String reportGroupName, String batchId, int sequenceNumber,
    ...
    long activityMissing, long expectedEligible, long actualEligible, long transformed, long failed, long expectedReportable,
    long actualReportable, long excluded, long simulated, long alreadyReported, long softDedup, long filtrationVariance,
