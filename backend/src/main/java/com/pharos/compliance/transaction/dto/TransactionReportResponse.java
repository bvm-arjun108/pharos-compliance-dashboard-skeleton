...
public record TransactionReportResponse(TransactionReportContextResponse context, TransactionMetric metric, String metricLabel,
    ...
    + "count doesn't match what record_transformation_journey actually recorded. Always false outside FAILED/SKIPPED.")
    boolean aggregateCountMismatch, long availableRecordCount, long matchingRecordCount, TransactionEvidenceLevel evidenceLevel,
    String evidenceMessage, List<TransactionEvidenceRecordResponse> transactions, String search, TransactionEvidenceSource source,
