...
public record BatchHealthTrendResponse(@Schema(example = "2026-08-01") LocalDate periodStart,
    ...
    @Schema(example = "2") long transformationFailureBatches, @Schema(example = "1") long missingAttemptBatches,
    @Schema(example = "1") long activityMissingBatches,
    @Schema(description = "Percentage of batches needing attention", example = "25.0") double attentionRate,
    @Schema(example = "2450") long totalReportedTransactions, @Schema(example = "6") long totalExcludedTransactions) {}
