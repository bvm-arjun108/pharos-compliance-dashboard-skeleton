...
/**
 * Resolves the nearest {@link SqlQueryPurpose}-annotated call frame via stack walking -- entirely
 * independent of jOOQ despite living in this package (a holdover from when this was invoked from a
 * jOOQ {@code ExecuteListener} hook; every repository has since migrated to hand-written SQL over
 * Spring JDBC, and this is called from {@code TracingNamedParameterJdbcTemplate} under {@code
 * com.pharos.compliance.common.jdbc.logging} instead).
 */
public final class SqlQueryPurposeResolver {
  static final String UNCLASSIFIED_QUERY = "Unclassified query";
